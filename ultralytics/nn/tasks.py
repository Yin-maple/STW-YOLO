...
from ultralytics.nn.modules import (
    ...
    SPPF,
    SPPFCSPC,
    A2C2f,SFC2f,C3k_CSP,Fusion,BiLevelRoutingAttention,Bottleneck_Attention,FEM,C3STR,SCAM,C3k_ST,SFC2f3,C2f_CloAtt,
    AConv,
    ADown,
    Bottleneck,
    BottleneckCSP,
    ...
    base_modules = frozenset(
        {
            ...
            SCDown,
            C2fCIB,
            A2C2f,SPSPPF,SFC2f,C3k_CSP,Bottleneck_Attention,FEM,C3STR,SCAM,C3k_ST,SFC2f3,C2f_CloAtt
        }
    )
    repeat_modules = frozenset(  # modules with 'repeat' arguments
        {
            ...
            C2fCIB,
            C2PSA,
            A2C2f,SFC2f,C3k_CSP,Bottleneck_Attention,C3STR,SCAM,C2fCPCA,C3k_ST,SFC2f3,C2f_CloAtt
        }
    )
