...
from ultralytics.nn.modules import (
    ...
    SPPF,
    SPPFCSPC,
    A2C2f,SFC2f,C2f_CloAtt,Fusion,BiLevelRoutingAttention,Bottleneck_Attention,FEM,
    AConv,
    ADown,
    Bottleneck,
    BottleneckCSP,
    ...
    base_modules = frozenset(
        {
            ...
            SCDown,
            C2fCIB,
            A2C2f,SPSPPF,SFC2f,C2f_CloAtt,Bottleneck_Attention,FEM
        }
    )
    repeat_modules = frozenset(  # modules with 'repeat' arguments
        {
            ...
            C2fCIB,
            C2PSA,
            A2C2f,SFC2f,C2f_CloAtt,Bottleneck_Attention
        }
    )
